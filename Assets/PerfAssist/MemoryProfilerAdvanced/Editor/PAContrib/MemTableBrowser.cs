...
public class MemTableBrowser
{
    ...
    public void MoveSelectItem(int value)
    {
        ...
        {
            _selectedTable.MoveSelectItem(value);
        }
    }

    public void ChangeSelectTable()
    {
        if(_selectedTable == null)
        {
            _selectedTable = _typeTable;
        }
        else if (_selectedTable == _typeTable)
        {
            _selectedTable = _objectTable;
        }
        else if (_selectedTable == _objectTable)
        {
            _selectedTable = _typeTable;
            _objectTable.SetSelected(null);
        }
        _selectedTable.MoveSelectItem(0);
    }
